...
const mockItems: EnhItem[] = [
  {
    ...
    slots: [
      ...
      { slot: 'Ring',   enhancement: 'Wizard',   focus: 'INT +45%' },
      { slot: 'Neck',   enhancement: 'Wizard',   focus: 'INT +45%' },
    ],
  ...
  },
  {
    ...
    slots: [
      ...
      { slot: 'Ring',   enhancement: 'Lucky',    focus: 'LUK +45%' },
      { slot: 'Neck',   enhancement: 'Lucky',    focus: 'LUK +45%' },
    ],
  ...
  },
  {
    ...
    slots: [
      ...
      { slot: 'Ring',   enhancement: 'Fighter',  focus: 'STR +45%' },
      { slot: 'Neck',   enhancement: 'Acolyte',  focus: 'WIS/END' },
    ],
  ...
  },
  {
    ...
    slots: [
      ...
      { slot: 'Weapon', enhancement: 'Thief of Hours', focus: 'DEX/LUK' },
      { slot: 'Ring',   enhancement: 'Lucky',          focus: 'LUK +45%' },
      { slot: 'Neck',   enhancement: 'Lucky',          focus: 'LUK +45%' },
    ],
  ...
  },
  {
    ...
    slots: [
      ...
      { slot: 'Ring',   enhancement: 'Acolyte',  focus: 'WIS +45%' },
      { slot: 'Neck',   enhancement: 'Acolyte',  focus: 'WIS +45%' },
    ],
  ...
  },
  {
    ...
    slots: [
      ...
      { slot: 'Ring',   enhancement: 'Lucky',    focus: 'LUK +45%' },
      { slot: 'Neck',   enhancement: 'Intercessor', focus: 'STR/LUK' },
    ],
